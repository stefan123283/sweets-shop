...
var button1 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(1) button"
);
var button2 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(2) button"
);
var button3 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(3) button"
);
var button4 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(4) button"
);
var button5 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(5) button"
);
var button6 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(6) button"
);
var button7 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(7) button"
);
var button8 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(8) button"
);
var button9 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(9) button"
);
var button10 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(10) button"
);
var button11 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(11) button"
);
var button12 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(12) button"
);
var button13 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(13) button"
);
var button14 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(14) button"
);
var button15 = document.querySelector(
  ".biscuits-container .biscuit:nth-child(15) button"
);
...
function saveProductInfo(orderNum) {
  let imgSrc = document
    .querySelector(`.biscuit:nth-child(${orderNum}) img`)
    .getAttribute("src");
  let productDetails = document.querySelector(
    `.biscuit:nth-child(${orderNum}) p:nth-child(2)`
  ).textContent;
  let productPrice = document.querySelector(
    `.biscuit:nth-child(${orderNum}) p:nth-child(3)`
  ).textContent;

  let product = {
    imgSrc: "../Biscuits/" + imgSrc,
