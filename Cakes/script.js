...
var button1 = document.querySelector(
  ".cakes-container .cake:nth-child(1) button"
);
var button2 = document.querySelector(
  ".cakes-container .cake:nth-child(2) button"
);
var button3 = document.querySelector(
  ".cakes-container .cake:nth-child(3) button"
);
var button4 = document.querySelector(
  ".cakes-container .cake:nth-child(4) button"
);
var button5 = document.querySelector(
  ".cakes-container .cake:nth-child(5) button"
);
var button6 = document.querySelector(
  ".cakes-container .cake:nth-child(6) button"
);
var button7 = document.querySelector(
  ".cakes-container .cake:nth-child(7) button"
);
var button8 = document.querySelector(
  ".cakes-container .cake:nth-child(8) button"
);
var button9 = document.querySelector(
  ".cakes-container .cake:nth-child(9) button"
);
var button10 = document.querySelector(
  ".cakes-container .cake:nth-child(10) button"
);
var button11 = document.querySelector(
  ".cakes-container .cake:nth-child(11) button"
);
var button12 = document.querySelector(
  ".cakes-container .cake:nth-child(12) button"
);
var button13 = document.querySelector(
  ".cakes-container .cake:nth-child(13) button"
);
var button14 = document.querySelector(
  ".cakes-container .cake:nth-child(14) button"
);
var button15 = document.querySelector(
  ".cakes-container .cake:nth-child(15) button"
);
...
function saveProductInfo(orderNum) {
  let imgSrc = document
    .querySelector(`.cake:nth-child(${orderNum}) img`)
    .getAttribute("src");
  let productDetails = document.querySelector(
    `.cake:nth-child(${orderNum}) p:nth-child(2)`
  ).textContent;
  let productPrice = document.querySelector(
    `.cake:nth-child(${orderNum}) p:nth-child(3)`
  ).textContent;
